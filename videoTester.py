...
while True:
    ...
    finalpred3 = (predictions2*0.3568) + \
        (predictions4*0.3146)+(predictions5*0.3286)
    # print(finalpred3)
    ...
    print(labels_class[np.argmax(predictions2)])
    print(labels_class[np.argmax(predictions4)])
    print(labels_class[np.argmax(predictions5)])
